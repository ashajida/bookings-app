...
const CalendarPage = () => {
  ...
  return (
    <div>
      <Calendar mode="range" initialFocus onMonthChange={setMonth} />
      <div className="w-100">
        <div>
                  ...
                  ? isBooked(day).map((booking, index) => (
                      ...
                      >
                        ...
                        <span className="block text-sm">
                          {booking.date.toISOString().split("T")[1].slice(0, 5)}
                        </span>
      ...
      <div className="w-100 flex gap-2">
            <div>
              <div>
                <span className="block text-sm">09:00</span>
              </div>
              <div>
                <span className="block text-sm">09:00</span>
              </div>
            ...
            <div className="flex gap-2">
              <div>
                <span className="block text-sm">Monday</span>
              </div>
              <div>
                <span className="block text-sm">Tuesday</span>
              </div>
              <div>
                <span className="block text-sm">Monday</span>
              </div>
